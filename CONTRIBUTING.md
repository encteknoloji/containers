...
- It must follow container best practices.
- The title of the PR is clear enough and starts with "[encteknoloji/container-name]"
...
1. Changes are manually reviewed by ENC Teknoloji team members usually within a business day.
2. The changes are automatically tested using our GitHub CI workflow.
3. Once the changes are accepted, the PR is tested (if needed) into the internal ENC Teknoloji CI pipeline. This may include testing both container and any associated Helm Chart.
